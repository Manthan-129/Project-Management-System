    ...
    <section className="relative min-h-[86vh] lg:min-h-[90vh] flex items-center px-5 pt-28 pb-8 lg:pb-10 lg:px-12">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-12 items-center">
        ...
        <div className="space-y-7">
          ...
          <div className="space-y-5 max-w-2xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-[1.08] tracking-tight">
              Calm control for <span className="bg-gradient-to-r from-blue-600 to-teal-500 bg-clip-text text-transparent">fast-moving</span> product teams.
            </h1>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link to={primaryCtaPath} className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-teal-600 text-white text-sm font-semibold rounded-xl shadow-sm transition-all no-underline">
        ...
        <div className="w-full">
          <div className="bg-white/95 rounded-2xl border border-blue-100 shadow-[0_20px_60px_-35px_rgba(18,33,58,0.45)] overflow-hidden">
            <div className="flex items-center gap-3 px-4 py-3 border-b border-blue-100 bg-gradient-to-r from-blue-50 to-teal-50">
            ...
            <div className="p-5 space-y-5">
              <div className="grid grid-cols-3 gap-3">
                {miniStats.map((stat) => (
                  <div key={stat.label} className="bg-gradient-to-br from-blue-50 to-teal-50 border border-blue-100 rounded-xl px-3 py-3 text-center">
                    <p className="text-xl font-bold bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">{stat.value}</p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {kanbanCols.map((col) => (
                  <div key={col.label} className="bg-gradient-to-br from-slate-50 to-blue-50 border border-slate-200 rounded-xl p-3 space-y-2">
