...
const getAppearanceSettings= async (req, res)=>{
    try{
        ...
        return res.status(500).json({success: false, message: "Error while fetching appearance settings"});
    }
}
...
module.exports= {getAppearanceSettings, updateAppearanceSettings};